...
class BH_AdminMetaboxes {
    ...
    public static function add_meta_boxes(): void {
        ...
        add_meta_box('bh_contest_judging', 'Judging Format', [self::class, 'render_contest_judging_box'], 'bh_contest', 'normal', 'default');

        add_meta_box('bh_contest_rounds', 'Rounds (elimination format)', [self::class, 'render_contest_rounds_box'], 'bh_contest', 'normal', 'default');

        add_meta_box('bh_contest_shortcode', 'Shortcode & Page', [self::class, 'render_contest_shortcode_box'], 'bh_contest', 'side', 'default');

        if (class_exists('OUS_Revisions')) {
            add_meta_box('bh_contest_revisions', 'Version History', [self::class, 'render_contest_revisions_box'], 'bh_contest', 'side', 'default');
        }

        add_meta_box('bh_contest_site_menu', 'Site Menu', [self::class, 'render_contest_site_menu_box'], 'bh_contest', 'side', 'default');
        ...
        add_meta_box('bh_contest_access', 'Access', [self::class, 'render_contest_access_box'], 'bh_contest', 'side', 'default');
    ...
    public static function render_contest_categories_box(\WP_Post $post): void {
        wp_nonce_field('bh_save_contest', 'bh_contest_nonce');
    ...
    public static function render_contest_judging_box(\WP_Post $post): void {
        wp_nonce_field('bh_save_contest', 'bh_contest_nonce');
    ...
    public static function render_contest_rounds_box(\WP_Post $post): void {
        wp_nonce_field('bh_save_contest', 'bh_contest_nonce');
    ...
    public static function render_contest_shortcode_box(\WP_Post $post): void {
    ...
    public static function render_contest_revisions_box(\WP_Post $post): void {
            OUS_Revisions::render_history_panel('bh_contest', $post->ID, 'bh_restore_contest_revision', 'bh_restore_contest_' . $post->ID);
    }

    public static function render_contest_site_menu_box(\WP_Post $post): void {
    ...
    public static function render_contest_access_box(\WP_Post $post): void {
    ...
    public static function render_contest_share_cards_box(\WP_Post $post): void {
    ...
    public static function render_contest_style_box(\WP_Post $post): void {
        wp_nonce_field('bh_save_contest', 'bh_contest_nonce');
