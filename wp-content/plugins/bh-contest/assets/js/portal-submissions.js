/**
 * portal-submissions.js — BH_PortalPanel's "Replace file" form
 * (class-portal-panel.php). Vanilla JS, no build step, same convention
 * as this ecosystem's other front-end widgets. bhContestPortalConfig
 * (wp_localize_script) carries restUrl + nonce.
 */
(function () {
    'use strict';
