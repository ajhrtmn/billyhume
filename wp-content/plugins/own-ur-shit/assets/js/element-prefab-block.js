...
(function (blocks, element, blockEditor, components, i18n, apiFetch) {
    ...
    blocks.registerBlockType('own-ur-shit/element-prefab', {
        ...
        edit: function (props) {
            ...
            var options = [{ label: __('— Select a prefab —', 'own-ur-shit'), value: 0 }].concat(prefabs.map(function (p) {
            ...
            return el('div', {}, el(InspectorControls, {}, el(PanelBody, { title: __('Prefab', 'own-ur-shit') }, el(SelectControl, {
