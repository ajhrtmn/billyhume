# Changelog — The Self-Hosted Self (own-ur-shit)

Moved out of `own-ur-shit.php` on 2026-08-23. That file was 2,555 lines
...
own-ur-shit + the peer plugins already whitelisted in .gitignore.
...
recompiled via `npm run build:own-ur-shit`. Deliberately plain `tsc`,
...
micro-state quick-link to (own-ur-shit's own Account/Log out links
