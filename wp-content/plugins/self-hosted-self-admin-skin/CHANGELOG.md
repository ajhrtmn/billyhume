# Changelog — Admin Skin — The Self-Hosted Self

Moved out of `self-hosted-self-admin-skin.php` on 2026-08-23. See `CONVENTIONS.md` for why version history lives here and in git rather than in source.
