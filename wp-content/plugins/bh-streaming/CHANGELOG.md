# Changelog — BH Streaming

Moved out of `bh-streaming.php` on 2026-08-23. See `CONVENTIONS.md` for why version history lives here and in git rather than in source.
...
much bigger live bug (a completely broken block-editor canvas on
