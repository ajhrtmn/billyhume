...
(function () {
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        lesson.querySelectorAll<HTMLVideoElement>('.bhc-step-video[data-watch-threshold]').forEach(function (video) {
        ...
        lesson.querySelectorAll<HTMLVideoElement>('.bhc-step-video').forEach(function (video) {
            ...
            function seekTo(seconds: number) {
                ...
                if (playResult && typeof playResult.catch === 'function') playResult.catch(function () { /* seek succeeded, playback just didn't auto-start */ });
            }
            ...
            if (video.readyState >= 1 /* HAVE_METADATA */) buildMarkers();
