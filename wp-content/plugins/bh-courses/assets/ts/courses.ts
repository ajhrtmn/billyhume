    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        lesson.addEventListener('click', function (e) {
            ...
            function submitMarkComplete(attempt: number) {
                fetch(BHCData.ajaxUrl, { method: 'POST', body: body })
                    .then(function (r) { return r.json() as Promise<-1 | '-1' | BHCAjaxResponse<BHCQuizSubmitResult>>; })
                    .then(function (res) {
        ...
        lesson.addEventListener('submit', function (e) {
            ...
            fetch(BHCData.ajaxUrl, { method: 'POST', body: body })
                .then(function (r) { return r.json() as Promise<BHCAjaxResponse<BHCQuizSubmitResult & { message?: string; max_attempts?: number }>>; })
                .then(function (res) {
