...
class BHC_Debug {
    ...
    private static function seed_course(string $title, bool $gated): int {
        ...
        $lesson2 = self::seed_lesson($course_id, 'Lesson 2: Writing a Hook', [
            ...
            ['type' => 'video', 'source' => 'url', 'video_url' => 'https://www.w3schools.com/html/mov_bbb.mp4', 'caption' => 'Example teaching video for this lesson (placeholder footage — swap for a real lesson recording).'],
