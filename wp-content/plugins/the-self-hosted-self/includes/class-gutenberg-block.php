 ...
 * attempted here.
 *
 * What this ships: ONE new block, 'the-self-hosted-self/element-prefab'. An
...
class OUS_Gutenberg_Block {
    ...
    // (the-self-hosted-self.php's bootstrap) — a second, nested add_action('init', ...)
    ...
    public static function register_block(): void {
        ...
        register_block_type('the-self-hosted-self/element-prefab', [
