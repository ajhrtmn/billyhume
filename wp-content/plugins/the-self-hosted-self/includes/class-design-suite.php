 ...
 *      load (the-self-hosted-self.php), same style as OUS_Dashboard::add_menu().
 ...
 *      ecosystem (the-self-hosted-self, ous-debug) versus the failure-prone shape
...
class BH_Design_Suite {
    ...
    public static function add_menu(): void {
        ...
        // trick OUS_Dashboard::add_menu() already uses for 'the-self-hosted-self'.
