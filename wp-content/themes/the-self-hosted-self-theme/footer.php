...
<footer class="oust-site-footer">
    ...
    <div class="oust-site-footer-inner">
        ...
        <nav class="oust-footer-col oust-footer-nav" aria-label="<?php esc_attr_e('Footer', 'the-self-hosted-self-theme'); ?>">
            <?php
            wp_nav_menu([
    ...
    <div class="oust-site-footer-bottom">
        <p>&copy; <?php echo esc_html(date('Y')); ?> <?php bloginfo('name'); ?>. <?php esc_html_e('All rights reserved.', 'the-self-hosted-self-theme'); ?></p>
    </div>
</footer>
