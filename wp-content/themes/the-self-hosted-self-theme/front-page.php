    ...
    <?php if (have_posts()) : ?>
        <div class="oust-container">
            <header class="oust-section-header">
                <span class="oust-section-kicker"><?php esc_html_e('Latest', 'the-self-hosted-self-theme'); ?></span>
                <h2 class="oust-section-title"><?php esc_html_e('From the Blog', 'the-self-hosted-self-theme'); ?></h2>
            </header>
